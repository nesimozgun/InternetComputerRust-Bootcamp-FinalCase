...
fn get_proposal_status(key: u64) -> String {
    ...
    match proposal {
        Some(proposal) => {
            //CONDITION: A proposal must have at least 5 votes to be eligible for evaluation. 
            ...
            //CONDITION: A status (Approved, Rejected, Passed) is only assigned if it earns at least 50% of the votes. 
